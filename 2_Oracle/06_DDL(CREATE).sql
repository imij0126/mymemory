...
/*
        ...
        - 자료형
                        * 문자 => 반드시 크기 지정을 해 줘야 함!
                                + CHAR (바이트 크기) : 고정길이 (고정된 길이의 데이터를 담을 경우)
                                                                                -> 지정한 길이보다 작은 값이 들어올 경우 공백으로 채워서 저장
                                                                                최대 2000바이트까지 지정 가능
                                + VARCHAR2(바이트 크기) : 가변길이 (데이터의 길이가 정해져있지 않는 경우)
                                                                                            -> 저장되는 데이터 길이만큼만 공간 크기가 사용
                                                                                            최대 4000바이트까지 지정 가능
                        * 숫자 : NUMBER
                        * 날짜 : DATE
*/
...
INSERT INTO MEMBER VALUES(1, 'leehi', '1234', '이혜인', '여', '010-1234-5678', 'leehi@gmail.com', SYSDATE);
...
INSERT INTO MEMBER_UNIQUE
            VALUES (1, 'KIDAWUN', '1234', '기다운', '남', '010-1234-1234', 'DAWUNI@GAMIL.COM', SYSDATE);
...
CREATE TABLE MEMBER_UNIQUE (
        ...
        MEM_PWD VARCHAR2(20) CONSTRAINT MEMPWE_NT NOT NULL,
...
/*
        CHECK(조건식) : 해당 컬럼에 저장할 수 있는 값에 대한 조건을 제시
                                            조건에 만족하는 값만들 저장할 수 있음
                                            => 정해진 값만을 저장하거나 할 때 사용
*/
...
INSERT INTO MEMBER_CHECK
            VALUES (1, 'hong', '1234', '홍길동', '남', NULL, NULL, NULL, SYSDATE);
...
--> 기본키 (MEM_NO)에 중복된 값을 저장하려고 할 때 제약 조건 위배됨! (=> UNIQUE 제약 조건 위배)

INSERT INTO MEMBER_PRI
            VALUES (NULL, 'ys333', '1234', '이요셉', '남', NULL, NULL, SYSDATE);
...
CREATE TABLE MEMBER (
            ...
            -- , FORGEIGN KEY (MEM_GRADEID) REFERENCES MEMBER_GRADE(GRADE_NO)   -- 테이블레벨방식
);
