...
//		printVariable();
	...
	public static void printVariable() {
		...
		System.out.println("홍길동 : " + (9870 * 8 * 14) + "원");
		System.out.println("차은우 : " + (9870 * 6 * 14) + "원");
		System.out.println("카리나 : " + (9870 * 6 * 14) + "원");
...
//	===============================================================
	public static void declareVariable() {
		 ...
		 *         => 클래스명의 경우 : 대문자로 시작하도록 지어 줌.
		 *      [2] 대소문자를 구분함
		 *      [3] 숫자로 시작하면 안됨, 예약어 사용 불가(이미 자바 내에서 사용되고 있는 이름들 - 바로 syntax 오류 뜸)
