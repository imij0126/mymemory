...
import com.kh.practice.set.controller.Lottery;
...
public class LotteryMenu {
	...
	public void insertObject() {
		// 추첨 대상 수를 입력받아 입력한 수만큼 정보를 저장
		System.out.print("추가할 추첨 대상 수 : ");
		int num = sc.nextInt();
		sc.nextLine();
		// 이름, 핸드폰 번호를 입력받아 Lottery 객체에 추첨자 정보 저장(객체 생성)
		for(int i=0; i<num; i++) {
			System.out.print("이름 : ");
			...
			if(!result) {	// 추첨자 정보 저장 실패(result값을 부정연산자를 통해 반대로 체크) --> 오류/중복대상/...
