 ...
 */
	public static void main(String[] args) {
		...
		System.out.println("내 PC 정보 : " + iNet.getHostName());		// "내 PC 정보 : xxxxx"
		...
		System.out.println("--------------");
		InetAddress[] iNet4 = InetAddress.getAllByName("tickets.interpark.com");
		
		System.out.println("인터파크티켓 호스트 개수 : " + iNet4.length);
		for(InetAddress ia : iNet4) {
			System.out.println("인터파크티켓 호스트명(서버명) : " + ia.getHostName());
			System.out.println("인터파크티켓 IP주소 : " + ia.getHostAddress());
		}
