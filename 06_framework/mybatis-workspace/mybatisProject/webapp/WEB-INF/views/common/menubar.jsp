...
<style>
	...
	.login-area a:hover { color: lightblue; }
    ...
    .menu a:hover { background-color: pink; }
</style>
</head>
<body>
<%
...
%>
    ...
    <div class="login-area container-fluid">
			...
			<c:when test="${ empty loginUser }">
		        ...
		        <form action="<%= contextPath %>/login.me" method="post">
		            ...
		            <table>
		                ...
		                <tr align="center">
		                    <th colspan="2">
		                        <button class="btn btn-sm btn-dark" type="submit">로그인</button>
		                        <button class="btn btn-sm btn-secondary" type="button" onclick="enrollPage();">회원가입</button>
		                    </th>
		                </tr>
		            </table>
		            <script>
