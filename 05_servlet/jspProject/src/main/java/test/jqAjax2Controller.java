...
public class jqAjax2Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		 ...
		 * 
		 * * 라이브러리 추가 필용 (json-simple-x.x.x.jar)
		 *   => https://code.google.com/archiev/p/json-simple/downloads
		 */
		// -- 배열 객체(JSONArray) 에 담아 응답 --> ArrayList 와 유사
		/*
		...
		response.getWriter().print(josnArr);
		*/
