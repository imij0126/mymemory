...
<body>
    ...
    <a href="views/2_Standard_Action/1_include.jsp">[1] jsp:include</a>
    <a href="views/2_Standard_Action/2_forward.jsp">[2] jsp:forward</a>
    ...
    <p>
    	...
    	공통적으로 사용되는 코드들을 합해 보다 쉽게 사용할 수 있도록 태그화하여 표준으로 제공되는 라이브러리
    </p>
    
    <h4>라이브러리 추가</h4>
    <ol>
    	<li><a href="https://tomcat.apache.org/">톰캣사이트</a>> 접속</li>
    	<li>메뉴에서 taglib 메뉴를 찾아 접속(Downloa-Taglibs)</li>
    ...
    <h4>JSTL 선언방법</h4>
    <p>
    	JSTL을 사용하기 위해 해당 jsp페이지 상단에 <br>
    	taglib 지시어를 사용해 선언 <br><br>
    ...
    <a href="views/3_Custom_Action/01_core.jsp">01_core</a>
    <a href="views/3_Custom_Action/prac1.jsp">prac1</a>
