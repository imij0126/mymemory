		...
		<div class="row">
			...
			<div class="col">
				<div class="input-group">
			  		...
			  		<input type="text" class="form-control" value="${ r1 }" readonly>
				</div>
			</div>
			...
			<div class="col">
				<div class="input-group">
			  		...
			  		<input type="text" class="form-control focus-ring focus-ring-danger" value="${ r2 }" readonly>
				</div>
			</div>			
		</div>
		...
		<div class="row">
			...
			<div class="col">
				...
				<div class="input-group">
			  		...
			  		<input type="text" class="form-control focus-ring focus-ring-success" value="${ r1 + r2 }" readonly>
				</div>
		...
		<div class="row">
			...
			<div class="col">
				...
				<div class="input-group">
			  		...
			  		<input type="text" class="form-control focus-ring focus-ring-success" value="${ r1 div r2 }" readonly>
				</div>
			...
			<div class="col">
				...
				<div class="input-group">
			  		...
			  		<input type="text" class="form-control focus-ring focus-ring-success" value="${ r1 mod r2 }" readonly>
				</div>
